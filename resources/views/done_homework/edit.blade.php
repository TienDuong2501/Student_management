...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form action="{{ route('done_homeworks.update', ['id' => $doneHomeWork->id]) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="home_work_id">
                  ...
                  @foreach($homeworks as $homework)
                    <option value="{{$homework->id}}" selected="{{ $doneHomeWork->home_work_id == $homework->id ? true : false }}">{{ $homework->name }}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="description">
                  {{ old('description') ?? trim($doneHomeWork->description) }}
                </textarea>
